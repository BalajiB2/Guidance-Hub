    ...
    <section class="home">
        <div class="text">
            <div class="profile-card">
                ...
                <h2 style="color:#2B68DD">Your Profile</h2>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <label for="profile_photo" style="cursor: pointer; display: inline-block; padding: 10px 15px; border: 1px solid #ccc; border-radius: 5px; background-color:#2B68DD; color: #fff;">Choose New Profile Picture
