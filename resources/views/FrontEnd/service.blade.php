...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
      ...
      <title>GuidanceHub|Service</title>
  ...
  <div id="preloader"></div>
    <nav class="navbar">
        <div class="brand-title">
          <a href="#"><img src="{{ asset('web/assets/logo2.png')}}"></a>
        </div>
      ...
      <footer>
        <div class="row">
            <div class="col">
                ...
                <h3>GuidanceHub <div class="under" style="text-align: justify;margin-top:0px;"><span></span></div></h3>
