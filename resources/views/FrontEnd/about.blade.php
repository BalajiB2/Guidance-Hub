...
<body>
  ...
  <section class="contact-section">
    ...
    <div class="tit-des">
      <p>GuidanceHub: Empowering Journeys, Unlocking Potential – Your Story of Personalized Excellence.</p>
    </div>
    ...
    <div class="tit-desc">
      <p>At GuidanceHub, our story is one of empowerment and growth. Founded with the vision of creating a platform that
        ...
        and expert-led skill enhancement,<br> GuidanceHub is dedicated to unlocking unique potential.
        Join our community and let GuidanceHub be your partner in personalized <br>excellence.</p>
    </div>
    ...
    <div class="teamimg">
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/1.jpg")}}">
        <p class="na">Anandh</p>
        <p class="role">Technology</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/10.jpg")}}">
        <p class="na">Arun</p>
        <p class="role">Product</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/3.jpg")}}">
        <p class="na">Toothless</p>
        <p class="role">Strategy</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/4.jpg")}}">
        <p class="na">Jane</p>
        <p class="role">Data</p>
      </div>
    </div>
    <div class="teamimg">
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/5.jpg")}}">
        <p class="na">Jeevan</p>
        <p class="role">Technology</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/9.jpeg")}}">
        <p class="na">John</p>
        <p class="role">QA</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/7.jpg")}}">
        <p class="na">Nobita</p>
        <p class="role">Technology</p>
      </div>
      <div class="teamr1">
        <img src="{{ asset("web/assets/img/8.jpg")}}">
        <p class="na">Eric Gladwin</p>
        <p class="role">Technology</p>
      </div>
    </div>
    ...
    <footer>
      <div class="row">
        <div class="col">
          ...
          <h3>GuidanceHub <div class="under" style="text-align: justify;margin-top:0px;"><span></span></div>
          </h3>
          <p style="font-size: 15px">At GuidanceHub, we connect you with expert creators for personalized guidance in
            career,
            skills, and exams. Committed to transparency and security, GuidanceHub is your partner in unlocking unique
            potential.
            Join us for a journey of tailored excellence</p>
        </div>
